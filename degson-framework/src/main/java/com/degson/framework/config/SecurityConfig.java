package com.degson.framework.config;
...
import com.degson.framework.config.properties.PermitAllUrlProperties;
import com.degson.framework.security.filter.JwtAuthenticationTokenFilter;
import com.degson.framework.security.handle.AuthenticationEntryPointImpl;
import com.degson.framework.security.handle.LogoutSuccessHandlerImpl;
...
//
//        config.addAllowedOrigin("*"); // 允许任何域进行跨域请求，或者设置特定的域
////        config.addAllowedHeader("*"); // 允许任何头进行跨域请求
////        config.addAllowedMethod("*"); // 允许任何方法进行跨  域请求
...
//        configuration.setAllowedOrigins(Arrays.asList("https://qiuqq.oicp.vip"));
